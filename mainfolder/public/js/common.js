...
async function downloadReceiptPDF() {
  ...
  try {
    // Temporarily strip zoom/rotation so we capture true dimensions
    ...
    // Grab the receipt's full outer HTML — server will render it with Puppeteer
    ...
    // Send to backend Puppeteer endpoint
    ...
    // Download the PNG blob returned by the server
